...
<body>
  ...
  <h2 class="opener">Looking for your perfect forever friend?</h2>
  ...
  <div class="mini-description">
    <img src="assets/images/conedog.jpg" alt="sad cone" class="description-pic">
    <div class="much-text">
      <h3 class="fun-greeting">What we do</h3>
      <ul class="filler">
        <li>Take descriptions of adoptable dogs!</li>
        <li>Place profiles of adoptable  dogs on our site!</li>
        <li>Let people customize their perfect dog!</li>
        <li>Find the perfect match for your new forever friend!</li>
      </ul>
      <h3 class="fun-greeting">Why we do it</h3>
      <ul class="filler">
        <li>To make it easier for shelters to display their dogs!</li>
        <li>To make sure no dog is left without a family!</li>
      </ul>
    </div>
  </div>
