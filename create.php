...
<!-- <svg width="1129" height="861" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M93.5 141.5L1 181.5c41.3 53 61.8 66 92.5 52 71.3 9.3 96 57.9 136 156.5 1 68.8 16.4 86.1 52.5 104.5 71.8 104 65.1 156.6 72 252.5 13.3 37-15.1 57-72 92.5h100c41.4-53.3 41.7-134.8 40-285 78.3-1 118.3-7.4 180.5-32 43.4-43.5 78.5-56.4 144.5-76l68.5 144c77.2 97.8 81.4 138.8 68 204.5-33.9-7-49 2.3-68 44.5l92 20 60-192.5c-65.1-63.1-61.4-121-24-241 75.8 189.4 115.1 215.6 184.5 241-156.5-144.5-49.3-247.6-220.5-433.5-164.5-32-359.6 32.4-433 0-86 12.6-134.3-19.8-220.5-132C233 24.1 218.3 8.2 189.5 1v76.5c-58.6 2-76.7 19.3-96 64z" stroke="#000"/>
</svg> -->
</div>
<div class="build">
...
<script>
    const colourMenu = document.querySelector('#colour');
    const dog = document.querySelector('.dog svg path:nth-child(1)');

    colourMenu.addEventListener('change', function() {
      dog.setAttribute("class", "")

      dog.classList.add(colourMenu.value);
    }
    );
  </script>
