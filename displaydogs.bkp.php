...
if (isset($_GET['dogAge'], $_GET['colour'], $_GET['size'], $_GET['temper']))
{
 //   $id = mysqli_real_escape_string($conn, $_GET['id']);
  ...
  $sql = "SELECT * FROM dogs WHERE colour = '$colour' AND temperament = '$temperament' AND size = '$size' AND `age bracket` = '$agebracket' ";
...
if (mysqli_num_rows($results) == 0)
  {echo "No Results Found for your Selections :(";}
?>
</h2>
</div>
<div class="list">
<?php foreach($selectdogs as $dogslist): ?>
  ...
  <div class="profile">
    <img class="profile-pic" src="<?php echo $dogslist['image']?>" width="230"
        height="230" alt="Picture of a Cute Dog"/>
   ...
   <li>Energy: <?php echo $dogslist['temperament']?></li>
...
<?php endforeach; ?>
<h2>Not what you were looking for? <a class="go-back" href="create.php">Go back to Create-a-Dog</a> or view <a class="go-back" href="ourdogs.php">all our dogs!</a></h2>
</div>
<?php 
